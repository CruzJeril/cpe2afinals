  ...
  return (
    <div className="App">
      <div className="Header">
        <h1>Jeril Roger Cipres Cruz</h1>
        <h2>BSCPE-2A</h2>
      </div>
      <div className="CalcContainer">
        <CalcDisplay display={disp} />
        <div className="ButtonContainer">
          <CalcButton label={"DIV"} onClick={opClickHandler} lineargradient={'#000000'} />
          ...
          <CalcButton label={"MUL"} onClick={opClickHandler} lineargradient={'#000000'} />
          ...
          <CalcButton label={"ADD"} onClick={opClickHandler} lineargradient={'#000000'} />
          ...
          <CalcButton label={"SUB"} onClick={opClickHandler} lineargradient={'#000000'} />
          ...
          <CalcButton label={"EXP"} onClick={opClickHandler} lineargradient={'#000000'} />
          <CalcButton label={"MOD"} onClick={opClickHandler} lineargradient={'#000000'} />
          <CalcButton label={"NEG"} onClick={negClickHandler} lineargradient={'#000000'} />
